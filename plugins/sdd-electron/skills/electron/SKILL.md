---
name: electron
description: Use when the user needs to interact with, automate, control, connect to, or test a running Electron desktop app (e.g. VS Code, Slack, Discord, Figma, Notion) — "automate Slack app", "control VS Code", "connect to desktop app", "test this Electron app", or any task requiring automation of a native Electron application.
