---
name: electron-dev
description: Use when starting a new Electron project, modernizing an existing one, or needing guidance on IPC patterns, security hardening, auto-updates, or packaging.
