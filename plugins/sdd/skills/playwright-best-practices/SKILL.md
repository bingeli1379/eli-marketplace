...
description: Use when writing, debugging, or stabilizing Playwright tests — flaky tests, Page Object Model, fixtures, CI configuration, network mocking and interception, auth/OAuth flows, visual and accessibility checks, performance budgets, tags and sharding. Covers E2E, component, API, visual, accessibility, security, Electron, and browser-extension testing with Playwright.
