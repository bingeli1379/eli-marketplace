...
description: >
  Use when reviewing C#/.NET code for performance, auditing hot paths or allocation-heavy patterns, or as a
  second opinion after manual perf review. Scans for ~50 anti-patterns across async, memory/allocations,
  strings, collections, LINQ, regex, serialization, and I/O, with tiered severity.
