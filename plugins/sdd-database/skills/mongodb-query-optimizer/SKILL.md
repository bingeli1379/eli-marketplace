...
description: Use when optimizing MongoDB queries and aggregation pipelines — index selection, explain-plan analysis, and read/write performance. Load when a repo uses MongoDB and a query, pipeline, or index needs tuning.
