...
description: Use when designing or reviewing MongoDB document schemas — embedding vs referencing, indexing strategy, schema validation, and modeling for the application's query patterns. Load when a repo uses MongoDB and you are shaping collections or documents.
