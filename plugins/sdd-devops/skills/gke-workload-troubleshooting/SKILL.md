...
description: Use when a GKE pod fails to start or keeps crashing — CrashLoopBackOff, OOMKilled / exit code 137, ImagePullBackOff, Pending — and you are reading its logs and events to find the cause. GKE-specific diagnosis; for writing or hardening the manifest afterwards use kubernetes-specialist.
metadata:
  category: Containers
