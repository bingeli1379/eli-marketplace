...
description: Use when setting a GKE workload's reliability controls — PodDisruptionBudgets, liveness / readiness / startup probes, graceful shutdown, topology spread constraints, replica counts. For cluster-level HA and platform topology use kubernetes-architect.
metadata:
  category: Containers
