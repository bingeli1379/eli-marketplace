...
description: Use when implementing GitLab CI/CD, optimizing pipeline performance, or setting up automated testing and deployment — multi-stage workflows, caching, and distributed runners for scalable automation.
