...
description: Use when configuring GKE workload autoscaling — HorizontalPodAutoscaler, VerticalPodAutoscaler, or right-sizing a workload's CPU / memory requests and limits. Workload level only; for node pool and cluster autoscaling use kubernetes-architect.
metadata:
  category: Containers
