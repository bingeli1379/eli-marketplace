...
- Discipline guardrails: EV must beat the estimate's error bar; bet only when the market hasn't already priced a scenario; discount form by opponent quality; claim the tilt, not the freak scoreline; in-sample accuracy is not a hit rate.
