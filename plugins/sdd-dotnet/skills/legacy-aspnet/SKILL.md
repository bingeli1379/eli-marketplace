---
name: legacy-aspnet
description: Use when working in a legacy ASP.NET codebase (.NET Framework 4.x, WebForms, MVC5, classic Web.config, IIS-hosted) — its patterns, constraints, and safe incremental modernization. Load before editing a non-SDK-style .NET Framework project.
