...
name: authentication
description: >
  Authentication and authorization patterns for .NET 10 applications. Covers JWT
  Bearer, ASP.NET Identity, policy-based authorization, OpenID Connect, and
  token generation.
  Load this skill when implementing authentication, authorization, JWT, login,
  or when the user mentions "auth", "JWT", "Bearer", "Identity", "authorize",
  "policy", "role", "claim", "OpenID Connect", "OIDC", "token", or "login".
