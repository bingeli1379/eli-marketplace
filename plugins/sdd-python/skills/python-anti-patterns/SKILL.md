...
description: Use when reviewing Python code for correctness and idiom — mutable default args, late binding, broad except, leaked resources, and other common footguns. A review lens for python-engineer self-checks and review-engineer.
