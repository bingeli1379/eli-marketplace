...
description: Use when designing or debugging LLM prompts — chain-of-thought, few-shot, structured-output prompting, and reusable prompt templates for production LLM features. Provider-agnostic.
