...
description: Use when building async Python — asyncio, async/await, concurrent I/O (gather, tasks, semaphores), async generators, and avoiding blocking calls in FastAPI or other ASGI services. For pytest of async code use python-testing-patterns.
