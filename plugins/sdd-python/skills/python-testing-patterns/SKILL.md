...
description: Use when writing pytest tests for Python — fixtures, parametrize, mocking (unittest.mock / pytest-mock), async test patterns, and coverage. Complements the test-driven-development methodology skill with pytest mechanics.
