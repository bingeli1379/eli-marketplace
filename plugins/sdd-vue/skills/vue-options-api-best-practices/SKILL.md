...
description: Use when writing or reviewing Vue in Options API style — data() / methods / computed / watch and `this` context, typically a legacy codebase that cannot move to Composition API. For Composition-API-first idioms use vue-best-practices.
version: 2.0.0
license: MIT
