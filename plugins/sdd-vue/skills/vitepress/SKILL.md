---
name: vitepress
description: Use when working on a VitePress docs site — its config, theme and layout, Markdown extensions, i18n, SSR, or build. For plain Vite app and build config use vite; for the Vue components rendered inside the site use vue.
metadata:
  author: Anthony Fu
  version: "2026.1.28"
