---
name: turborepo
description: Use when working with Turborepo — turbo.json, task pipelines, dependsOn, local and remote caching, --filter / --affected runs, boundaries, or monorepo package structure. For the package manager and workspace catalogs use pnpm.
metadata:
