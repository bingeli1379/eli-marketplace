...
| [agent-ops](./plugins/agent-ops) | Look after the AI setup itself — audit which installed MCP servers, tools, and skills actually get used, and write/audit/refine the prompt files you add | Claude Code · Codex |
